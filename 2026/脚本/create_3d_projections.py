...
class Create3DProjections:
    ...
    def create_cost_time_projection(self):
        ...
        # 设置标题
        ax.set_title('Stage 1: Cost vs Time Projection', fontsize=16, pad=20)
        ...
        # 保存图形
        output_file = os.path.join(result_dir, 'Q4_Stage1_Cost_Time_Projection.png')
    ...
    def create_cost_emissions_projection(self):
        ...
        # 设置标题
        ax.set_title('Stage 1: Cost vs Emissions Projection', fontsize=16, pad=20)
        ...
        # 保存图形
        output_file = os.path.join(result_dir, 'Q4_Stage1_Cost_Emissions_Projection.png')
        plt.savefig(output_file, dpi=300, bbox_inches='tight')
    ...
    def create_time_emissions_projection(self):
        ...
        # 设置标题
        ax.set_title('Stage 1: Time vs Emissions Projection', fontsize=16, pad=20)
        ...
        # 保存图形
        output_file = os.path.join(result_dir, 'Q4_Stage1_Time_Emissions_Projection.png')
        plt.savefig(output_file, dpi=300, bbox_inches='tight')
