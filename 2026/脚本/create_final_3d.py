...
class CreateFinal3D:
    ...
    def generate_data(self, n_points=5000):
        """使用与Q4_LCA_Projections.py相同的方法生成数据"""
        # 基础变量
    ...
    def create_3d_plot(self):
        ...
        # 设置标题
        ax.set_title('3D Combined View: Cost vs Time vs Emissions', fontsize=14, pad=20)
